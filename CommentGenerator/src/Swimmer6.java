...
public class Swimmer6 extends JFrame {
	...
	public Swimmer6() {
		...
		skills = new String[]
		{
			...
			"Breaststroke (arms)",
			"Breaststroke (whipkick)",
			"Front Crawl (coordination)",
			"Front Crawl (arms)",
			"Front Crawl (breathing)",
			"Front Crawl (kicking)",
			"Back Crawl (coordination)",
			"Back Crawl (arms)",
			"Back Crawl (kicking)",
			"Head Up Swim (head position)",
			"BreastStroke (sprint)",
			"Endurance"
		};
