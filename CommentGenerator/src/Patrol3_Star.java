...
public class Patrol3_Star extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Patrol3_Star frame = new Patrol3_Star();
	...
	public Patrol3_Star() {
		...
		skills = new String[]
		{
			...
			"Endurance",
			"Care for Bone Injury",
			"Care for Respitory Emergency",
			"20m Rescue"
		};
		...
		title = new JLabel("Star Patrol");
		title.setFont(new Font("Lucida Grande", Font.PLAIN, 20));
		title.setBounds(180, 5, 168, 25);
